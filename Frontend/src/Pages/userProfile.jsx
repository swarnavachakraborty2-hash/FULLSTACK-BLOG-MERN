        ...
        <div className="profile-card">
          ...
          {id !== currUserID && (
            <div style={{ marginTop: 16 }}>
              {followedToUser ? (
                <button className="btn-ghost" onClick={onFollow}>Unfollow</button>
              ) : followedByUser ? (
                <button onClick={onFollow}>Follow Back</button>
              ) : (
        ...
        <div className="profile-posts-section">
          ...
          {loading ? (
            ...
            <div className="profile-empty-state">
              ...
              <p className="profile-empty-subtitle">Nothing shared here yet.</p>
            </div>
          )}
        </div>
      </div>
